package ejercicio1.inlineAnonima;
...
public class Ejercicio1 {
	...
	public static void main(String[] args) {
		...
		Predicate<Integer> pares = new Predicate<Integer>() {
		...
		Predicate<Integer> impares = new Predicate<Integer>() {
		...
		Predicate<Integer> mayores = new Predicate<Integer>() {
		...
		UnaryOperator<Integer> doble = new UnaryOperator<Integer>() {
		...
		UnaryOperator<Integer> triple = new UnaryOperator<Integer>() {
